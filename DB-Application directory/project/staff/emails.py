...
def email_sending_logic(name, job_name, email):
    try:
        ...
        sender_address = 'ats4success@gmail.com'
        sender_pass = 'password226'
...
def email_sending_logic_offer(name, job_name, email):
    try:
        mail_content_html = '''
                          <!DOCTYPE html>
                        <html lang="en" dir="ltr">
...
def email_sending_logic_interview(name, job_name, email):
    try:
        mail_content_html = '''
                          <!DOCTYPE html>
                        <html lang="en" dir="ltr">
